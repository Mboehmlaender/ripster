...
export default function SettingsPage() {
  ...
  const handleDeleteScript = async (script) => {
    ...
    const confirmed = await confirmModal({
      header: 'Script löschen',
      message: `Script "${script?.name || scriptId}" wirklich löschen?`,
      acceptLabel: 'Löschen',
  ...
  const handleDeleteChain = async (chain) => {
    ...
    const confirmed = await confirmModal({
      header: 'Skriptkette löschen',
      message: `Skriptkette "${chain?.name || chainId}" wirklich löschen?`,
      acceptLabel: 'Löschen',
      rejectLabel: 'Abbrechen',
      danger: true
    });
