...
REPO_OWNER="michael"
REPO_NAME="ripster"
REPO_RAW_BASE="${GITEA_BASE}/${REPO_OWNER}/${REPO_NAME}/raw/branch"
...
INSTALL_SCRIPT="${TMP_DIR}/gitea_install.sh"
INSTALL_URL="${REPO_RAW_BASE}/${SELECTED_BRANCH}/gitea_install.sh"

echo "Lade gitea_install.sh aus Branch '${SELECTED_BRANCH}'..."
